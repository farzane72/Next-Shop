...
const Specifications: React.FunctionComponent<SpecificationsProps> = (
  props
) => {
 ...
 // console.log(newSpecifications);
  ...
  //   setNewSpecifications(({...newSpecifications}))
  // },[newSpecifications])
  ...
  const saveHandler = () => {
   ...
   // newSpecifications.push({[name]:value})
  ...
  const deleteHandler = (index: number) => {
    ...
    //setNewSpecifications([...specifications]);
  };
  return (
          ...
          <div>
            {
                ...
                newSpecifications &&(
                  newSpecifications.map((specification: any, index: number) => (
                    //  Object.entries(newSpecifications).map(([key, value],index) => (
                        <div
                         key={index}
                        ...
                        >
                          ...
                          {Object.keys(specification)}:{Object.values(specification)}
                             {/* {
                               Object.values(specification).map((i:any) => (
